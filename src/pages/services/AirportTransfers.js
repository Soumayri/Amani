      ...
      <div className="service-page">
        ...
        <div className="service-content">
          ...
          <ul className="service-benefits">
            <li>
              <FaUserCheck className="benefit-icon" /> <strong>{t("Personalized Pickup")}</strong> – {t("Your driver waits with a sign at the airport.")}
            </li>
            <li>
              <FaMoneyBillWave className="benefit-icon" /> <strong>{t("Fixed Transparent Pricing")}</strong> – {t("No surprises! Know the fare in advance.")}
            </li>
            <li>
              <FaCar className="benefit-icon" /> <strong>{t("Comfortable & Safe")}</strong> – {t("Modern, air-conditioned, and well-maintained.")}
            </li>
            <li>
              <FaClock className="benefit-icon" /> <strong>{t("24/7 Availability")}</strong> – {t("Service at any hour, regardless of your flight schedule.")}
            </li>
            <li>
              <FaCheckCircle className="benefit-icon" /> <strong>{t("Exclusive")}</strong> – {t("Available as an optional service for other plans.")}
            </li>
          </ul>
          ...
          <div className="cta-section">
            ...
            <button
              ...
              onClick={() => navigate("/contact?service=Airport Transfers")}
            >
